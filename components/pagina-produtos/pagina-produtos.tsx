        ...
        <div className="flex justify-start mb-12">
          <div className="relative w-full max-w-sm">
            <input
              ...
              className="w-full bg-white text-rock-red placeholder:text-rock-red rounded-full py-3 pl-6 pr-12 focus:outline-none focus:ring-2 focus:ring-rock-red shadow-lg transition-all font-medium"
            />
           <div className="absolute right-4 top-1/2 -translate-y-1/2 text-rock-red cursor-pointer hover:scale-[1.05] transition-transform duration-300">
