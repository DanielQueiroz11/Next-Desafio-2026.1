              ...
              <div className="p-6 flex flex-col h-auto">
                ...
                <div className="mt-auto">
                  ...
                  <span className="block text-gray-400 text-sm mb-6">
                    {product.installment.split(/(R\$\d+,\d+)/).map((part, index) => (
                      <span 
                        key={index} 
                        className={part.startsWith("R$") ? "text-rock-red font-bold" : ""}
                      >
                        {part}
                      </span>
                    ))}
                  ...
                  <button className="w-full bg-rock-red text-white font-bold py-3 rounded-full hover:bg-red-700 active:scale-95 transition-all shadow-md">
                    Ver mais
                  </button>
                </div>
              </div>
