          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="border border-white/10 rounded-lg p-6 md:p-10 lg:p-8 bg-[#121212] flex-1">
              ...
              <div className="grid grid-cols-2 gap-6 justify-items-center md:justify-items-start lg:justify-items-start">
                <a href="https://www.instagram.com/codejr" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 cursor-pointer hover:text-rock-red transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
                  <span className="font-bold text-sm">Instagram</span>
                </a>

                <a href="https://www.facebook.com/codeempresajunior" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 cursor-pointer hover:text-rock-red transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
                  <span className="font-bold text-sm">Facebook</span>
                </a>

                <a href="https://www.codejr.com.br/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 cursor-pointer hover:text-rock-red transition-colors">
                ...
                <a href="https://www.linkedin.com/company/codejr" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 cursor-pointer hover:text-rock-red transition-colors">
