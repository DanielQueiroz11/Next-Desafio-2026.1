  ...
  return (
    <footer className="w-full bg-rock-dark text-white py-10 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-3 gap-8 items-center text-center md:text-left">
        ...
        {/* logo */}
        <div className="flex justify-center md:justify-center self-start md:-mt-4 md:order-2 pb-1">
          <Link
            href="/"
        ...
        {/* contato */}
        <div className="flex flex-col items-center md:items-end gap-4 self-start md:order-3 pt-5">
