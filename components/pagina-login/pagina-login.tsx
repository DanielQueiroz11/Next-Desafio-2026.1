...
export default function PaginaLogin() {
  ...
  return (
    <main className="relative min-h-screen w-full flex items-center justify-center bg-rock-dark overflow-hidden px-4">
      ...
      {/* card login */}
      <div className="relative z-10 w-full max-w-[450px] bg-black/70 backdrop-blur-sm p-8 md:p-10 rounded-2xl shadow-2xl border border-white/10 mt-3 md:mt-4">
        {/* título */}
        ...
        <form className="flex flex-col gap-5" onSubmit={handleLogin}>
          ...
          <div className="flex flex-col gap-2">
            <label
              htmlFor="name"
              className="text-white font-bold ml-1 text-[18px]"
            >
              Nome
            </label>
            <input
