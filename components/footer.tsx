  ...
  return (
    <footer className="w-full bg-rock-dark text-white py-5 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-3 gap-8 items-center text-center md:text-left">
        ...
        {/* logo */}
        <div className="flex justify-center md:justify-center self-start md:-mt-4 md:order-2 pb-2">
          <Link
            href="/"
        ...
        {/* redes sociais */}
        <div className="flex flex-col items-center md:items-start gap-4 md:order-1 self-start md:pt-3">
          <Link 
          ...
          <div className="flex gap-4">
            ...
            <a href="#" className="hover:text-rock-red transition-colors">
          ...
          {/* copyright PC*/}
          <div className="hidden md:block text-xs text-gray-400 pt-6 font-mono text-left">
